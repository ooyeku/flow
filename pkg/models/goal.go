...
// ConvertDeadtime converts a date string to a time.Time value using the format "2006-01-02". It returns the converted time value and an error if the conversion fails.
func (g *Goal) ConvertDeadtime(date string) (time.Time, error) {
